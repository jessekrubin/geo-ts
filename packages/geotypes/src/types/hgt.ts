...
type EastLongitudesNumbers =
  | HgtLongitudesGreaterThan99
  | HgtLongitudesLessThan100;
...
export type HgtFilename =
  | NorthEastHgtFilename
  | NorthWestHgtFilename
  | SouthEastHgtFilename
  | SouthWestHgtFilename;
