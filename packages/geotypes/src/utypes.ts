...
export type IsVoid<T> = IsUndefined<T> extends true
  ? true
  : IsNull<T> extends true
    ? true
    : false;
export type IsUnknownOrUndefined<T> = IsUnknown<T> extends true
  ? true
...
export type ExtendsVoid<T> = ExtendsUndefined<T> extends true
  ? true
...
export type ExtendsUnknownOrUndefined<T> = ExtendsUnknown<T> extends true
  ...
  : ExtendsUndefined<T> extends true
    ? true
    : false;
export type IsNullable<T> = IsVoid<T> extends true
  ? true
